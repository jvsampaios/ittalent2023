...
4- Instale o Virtual Box [Oracle VM VirtualBox](https://www.virtualbox.org/)

5- Crie uma conta no site do Vagrant para ter acesso aos boxes de images [My Vagrant Boxes - Vagrant Cloud (vagrantup.com)](https://app.vagrantup.com/)
